...
Solutions are presented in this format [[g, k], [g, k], [g, k], [g, k]]
where `g` and `k` represent the row and column, respectively, where a
...
def xout(board, row, col):
    ...
    for g in range(row + 1, len(board)):
        board[g][col] = "x"
    # X out all spots above
    for g in range(row - 1, -1, -1):
        board[g][col] = "x"
